import { ShiftState, calculateResult, findCommonElements, getState, sortInputByDate, extractDate, parseDate, parseInputByShifts } from '../solution-pt1';
...
describe('day 4. part 1', () => {
  ...
  test('it must sort array by date', () => {
    const testData = ['[1518-11-04 00:05] falls asleep', '[1518-11-11 00:46] wakes up', '[1518-11-03 00:24] falls asleep', '[1518-11-03 00:21] falls asleep'];
  ...
  test('it must calculate answer', async () => {
    const data = await inputLoader('day-four', (data: string) => data.split('\r\n'));
